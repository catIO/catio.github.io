...
import {
  ...
  useLayoutEffect2
} from "./chunk-S647WYSQ.js";
import {
  Primitive,
  dispatchDiscreteCustomEvent
} from "./chunk-RDHMCQ3E.js";
import {
  require_react_dom
...
var ToastProvider = (props) => {
  ...
  const [toastCount, setToastCount] = React6.useState(0);
  const isFocusedToastEscapeKeyDownRef = React6.useRef(false);
  const isClosePausedRef = React6.useRef(false);
  if (!label.trim()) {
    console.error(
  ...
  return (0, import_jsx_runtime4.jsx)(Collection.Provider, { scope: __scopeToast, children: (0, import_jsx_runtime4.jsx)(
    ToastProviderProvider,
    {
      ...
      onToastAdd: React6.useCallback(() => setToastCount((prevCount) => prevCount + 1), []),
      onToastRemove: React6.useCallback(() => setToastCount((prevCount) => prevCount - 1), []),
...
var ToastViewport = React6.forwardRef(
  (props, forwardedRef) => {
    const {
      __scopeToast,
    ...
    const headFocusProxyRef = React6.useRef(null);
    const tailFocusProxyRef = React6.useRef(null);
    ...
    const getSortedTabbableCandidates = React6.useCallback(
      ({ tabbingDirection }) => {
...
var FocusProxy = React6.forwardRef(
  (props, forwardedRef) => {
...
var ToastImpl = React6.forwardRef(
  (props, forwardedRef) => {
    const {
      __scopeToast,
      type = "foreground",
    ...
    const composedRefs = useComposedRefs(forwardedRef, (node2) => setNode(node2));
    const pointerStartRef = React6.useRef(null);
    const swipeDeltaRef = React6.useRef(null);
    const duration = durationProp || context.duration;
    const closeTimerStartTimeRef = React6.useRef(0);
    const closeTimerRemainingTimeRef = React6.useRef(duration);
    ...
    const startTimer = React6.useCallback(
      (duration2) => {
    ...
    const announceTextContent = React6.useMemo(() => {
...
var ToastAnnounce = (props) => {
  ...
  const context = useToastProviderContext(TOAST_NAME, __scopeToast);
  const [renderAnnounceText, setRenderAnnounceText] = React6.useState(false);
  const [isAnnounced, setIsAnnounced] = React6.useState(false);
...
var ToastTitle = React6.forwardRef(
  (props, forwardedRef) => {
...
var ToastDescription = React6.forwardRef(
  (props, forwardedRef) => {
...
var ToastAction = React6.forwardRef(
  (props, forwardedRef) => {
...
var ToastClose = React6.forwardRef(
  (props, forwardedRef) => {
...
var ToastAnnounceExclude = React6.forwardRef((props, forwardedRef) => {
